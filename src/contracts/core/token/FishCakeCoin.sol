...
contract FishCakeCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, FishCakeCoinStorage {
    ...
    function _beforePoolAddress(fishCakePool memory _pool) internal virtual {
        ...
        require(_pool.nftSalesRewardsPool != address(0), "FishCakeCoin _beforeAllocation:Missing allocate NFTSalesRewardsPool address");
        require(_pool.ecosystemPool != address(0), "FishCakeCoin _beforeAllocation:Missing allocate EcosystemPool address");
        require(_pool.foundationPool != address(0), "FishCakeCoin _beforeAllocation:Missing allocate FoundationPool address");
    }
}
